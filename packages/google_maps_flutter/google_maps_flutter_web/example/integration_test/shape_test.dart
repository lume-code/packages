...
void main() {
  ...
  group('PolygonController', () {
    ...
    group('onEdited', () {
      ...
      testWidgets('fires onEdited on setAt with outer path and holes', (
        WidgetTester tester,
      ) async {
        final completer =
            Completer<({List<gmaps.LatLng> outer, List<List<gmaps.LatLng>> holes})>();
        PolygonController(
          polygon: editablePolygon,
          onEdited:
              (List<gmaps.LatLng> outer, List<List<gmaps.LatLng>> holes) {
      ...
      testWidgets('fires onEdited when a hole path is mutated', (
        WidgetTester tester,
      ) async {
        final completer =
            Completer<({List<gmaps.LatLng> outer, List<List<gmaps.LatLng>> holes})>();
      ...
      testWidgets('remove cancels onEdited subscriptions', (
        WidgetTester tester,
      ) async {
        var callCount = 0;
  ...
  group('PolylineController', () {
    ...
    group('onEdited', () {
      ...
      testWidgets('fires onEdited on setAt with updated path', (
        WidgetTester tester,
      ) async {
        final completer = Completer<List<gmaps.LatLng>>();
        PolylineController(
      ...
      testWidgets('fires onEdited on insertAt with updated path', (
        WidgetTester tester,
      ) async {
        final completer = Completer<List<gmaps.LatLng>>();
        PolylineController(
      ...
      testWidgets('fires onEdited on removeAt with updated path', (
        WidgetTester tester,
      ) async {
        final completer = Completer<List<gmaps.LatLng>>();
        PolylineController(
